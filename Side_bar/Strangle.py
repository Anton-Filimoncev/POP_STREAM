...
def strangle():
    ...
    if st.button("Calculate", type="primary"):
        ...
        strengle_data, best_df, exp_move_hv, exp_move_iv = get_strangle(tick, rate, percentage_array, days_to_expiration, closing_days_array, quotes)

        st.text('Best Parameters:')
        st.dataframe(best_df[['pop', 'exp_return', 'cvar', 'Strike Call', 'Strike Put']], hide_index=True, column_config=None)
